...
describe('ErrorResponse', () => {
  ...
  it('should use provided statusCode', () => {
    const response = new ErrorResponse('Not Found', 404);
  ...
  it('should use provided data', () => {
    ...
    const response = new ErrorResponse('Validation failed', 422, data);

    expect(response.data).toEqual(data);
  });

  it('should use provided name', () => {
    const response = new ErrorResponse('Not Found', 404, null, 'NOT_FOUND');
